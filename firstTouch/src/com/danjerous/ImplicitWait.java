...
public class ImplicitWait {
    ...
    public static void explicitWait() {
        ...
        WebDriverWait delayedDriver = new WebDriverWait(driver,20);
        delayedDriver.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("a[target='17117062']")));
